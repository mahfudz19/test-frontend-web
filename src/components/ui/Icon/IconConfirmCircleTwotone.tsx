...
const IconConfirmCircleTwotone = forwardRef<SVGSVGElement, IconProps>((props: IconProps, ref) => {
...
IconConfirmCircleTwotone.displayName = 'IconConfirmCircleTwotone'

export default IconConfirmCircleTwotone
