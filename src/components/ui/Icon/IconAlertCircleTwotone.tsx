...
const IconAlertCircleTwotone = forwardRef<SVGSVGElement, IconProps>((props: IconProps, ref) => {
...
IconAlertCircleTwotone.displayName = 'IconAlertCircleTwotone'

export default IconAlertCircleTwotone
