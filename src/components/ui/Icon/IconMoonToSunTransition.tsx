...
const IconMoonToSunTransition = forwardRef<SVGSVGElement, IconProps>((props: IconProps, ref) => {
  ...
  return (
    ...
    >
      ...
      <g fill='currentColor' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' strokeWidth='2'>
        ...
        <animate fill='freeze' attributeName='opacity' begin='0.6s' dur='0.4s' values='0;0' />
      </g>
...
IconMoonToSunTransition.displayName = 'IconMoonToSunTransition'

export default IconMoonToSunTransition
