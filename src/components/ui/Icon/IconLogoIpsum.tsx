...
const IconLogoIpsum = forwardRef<SVGSVGElement, IconProps>(
  (props: IconProps, ref) => {
    ...
    return (
      <svg
        {...rest}
        ref={ref}
        className={twMerge("fill-current", variantsIcon({ color, className }))}
        width={`${fontSize}`}
        height={`${fontSize}`}
...
IconLogoIpsum.displayName = "IconLogoIpsum";

export default IconLogoIpsum;
