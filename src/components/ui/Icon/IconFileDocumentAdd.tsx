...
const IconFileDocumentAdd = forwardRef<SVGSVGElement, IconProps>((props: IconProps, ref) => {
...
IconFileDocumentAdd.displayName = 'IconFileDocumentAdd'

export default IconFileDocumentAdd
