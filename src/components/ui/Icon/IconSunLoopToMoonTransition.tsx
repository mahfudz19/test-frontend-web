...
const IconSunLoopToMoonTransition = forwardRef<SVGSVGElement, IconProps>((props: IconProps, ref) => {
    ...
    >
      <g fill='none' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' strokeWidth='2'>
        ...
        <path
          ...
          opacity='0'
        >
          <animate fill='freeze' attributeName='opacity' begin='0.6s' dur='0.4s' to='1' />
        </path>
      </g>
      ...
      <circle cx='12' cy='12' r='6' fill='currentColor' mask='url(#lineMdSunnyFilledLoopToMoonFilledTransition0)'>
        <animate fill='freeze' attributeName='opacity' begin='0.6s' dur='0.4s' to='0' />
...
IconSunLoopToMoonTransition.displayName = 'IconSunLoopToMoonTransition'

export default IconSunLoopToMoonTransition
